...
`Dashboard` zeigt deine wichtigsten Kennzahlen und den Schnellzugriff auf Gegner.
...
`Training` enthaelt 501 Double Out gegen Computer-Gegner, Doppeltraining und Scoring Checks. Cup-Gegner werden in der Trainingsbewertung beruecksichtigt, sobald sie als Kategorie `Cup` oder `Liga + Cup` gespeichert sind.
